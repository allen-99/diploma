...
urlpatterns = [
    ...
    path('deletetheme/<int:row_id>/', views.delete_theme, name='delete_theme'),
    path('deletecompany/<int:row_id>/', views.delete_company, name='delete_company'),
    path('deletereviews/<int:row_id>/', views.delete_reviews, name='delete_reviews'),
    ...
    path('learnreviews', views.learnreviews, name='learnreviews'),
